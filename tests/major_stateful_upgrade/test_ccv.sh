...
echo "Delegating additional stake to $MONIKER_2..."
$CHAIN_BINARY --home $HOME_1 tx staking delegate $VALOPER_1 $DELEGATE_2_AMOUNT$DENOM --from $MONIKER_2 --keyring-backend test --gas $GAS --gas-adjustment $GAS_ADJUSTMENT --fees 1000$DENOM -b block -y --chain-id $CHAIN_ID
