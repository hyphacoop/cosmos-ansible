...
tests/v12_upgrade/log_lsm_data.sh happy-bond pre-delegate $WALLET_2 $delegation
...
tests/v12_upgrade/log_lsm_data.sh happy-bond post-delegate $WALLET_2 $delegation
...
tests/v12_upgrade/log_lsm_data.sh happy-bond post-bond $WALLET_2 -
