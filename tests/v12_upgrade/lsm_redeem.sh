...
sleep 20
$STRIDE_CHAIN_BINARY q bank balances $STRIDE_WALLET_5 --home $STRIDE_HOME_1
...
submit_tx "tx ibc-transfer transfer transfer channel-1 $WALLET_5 10000000$tokenized_denom --from $STRIDE_WALLET_5 -o json --gas auto --gas-adjustment 1.2  --fees $CONSUMER_FEES$STRIDE_DENOM -b block -y" $STRIDE_CHAIN_BINARY $STRIDE_HOME_1
