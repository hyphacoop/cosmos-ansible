...
cp tests/ics_tests/hermes-config.toml ~/.hermes/config.toml
...
hermes keys add --chain five-v330 --mnemonic-file mnemonic.txt
hermes keys add --chain six-v400 --mnemonic-file mnemonic.txt
