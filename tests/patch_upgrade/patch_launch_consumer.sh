...
$CHAIN_BINARY tx gov submit-proposal consumer-addition proposal-add-$CONSUMER_CHAIN_ID.json --gas auto --gas-adjustment $GAS_ADJUSTMENT --fees $HIGH_FEES$DENOM --from $MONIKER_1 --keyring-backend test --home $HOME_1 --chain-id $CHAIN_ID -y
sleep 10
