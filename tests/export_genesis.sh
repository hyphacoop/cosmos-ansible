...
then
    echo \"Creating cosmovisor/upgrades/v10/bin directory\"
    mkdir -p cosmovisor/upgrades/v10/bin
    cp cosmovisor/genesis/bin/gaiad cosmovisor/upgrades/v10/bin/gaiad
fi
" > ~gaia/quicksync.sh
